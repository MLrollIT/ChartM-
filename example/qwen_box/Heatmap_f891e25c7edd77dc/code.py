...
# Increase the border thickness of the cells that contain the center point of the bounding box to 2.6 pixels and change the border color to #a9258d
for text in ax.texts:
    if text.get_bbox().get_width() == 2.6:
        text.set_bbox(dict(boxstyle="square", ec="#a9258d", lw=2.6))
