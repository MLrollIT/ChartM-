...
# Change the background color of the cells that contain the center point of the bounding box to #076bf0
# Also, for these cells, increase the border thickness to 2.5 pixels and set the border color to #d692ac
...
bbox = ax.bbox_to_anchor((0.5, 0.5), pad=10)
bbox = ax.bbox_to_anchor((0.5, 0.5), pad=10)
bbox = ax.bbox_to_anchor((0.5, 0.5), pad=1