...
# Update the edge color of the scatter points that share the same legend as those containing the center point of the bounding box to #d77716, and set the edge width to 2.6. Also, add a shadow effect to these points with a 7.2-pixel offset and a foreground color of silver.
