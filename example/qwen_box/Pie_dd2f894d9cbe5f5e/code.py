...
# Change the label of the slice that contains the center point of the bounding box to 'A new Label' and set its rasterized state to True
for autotext in autotexts:
    autotext.set_text('A new Label')
    autotext.set_rasterized(True)
