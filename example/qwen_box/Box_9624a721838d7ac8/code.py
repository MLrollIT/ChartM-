...
# Change the face color of the box body that contain the center point of the bounding box to #144182, and also hide the box's caps by setting their visibility to False.
for box in bp['boxes']:
    box.set_facecolor('#144182')
