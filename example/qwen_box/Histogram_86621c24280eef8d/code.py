...
bars = plt.gca().collections[0].get_paths()[bbox.get_points()]

# Get the bar heights
heights = [bar.vertices[1,1] for bar in bars]

# Reduce the height of the bars to 70% of their original height
heights = [height * 0.7 for height in heights]

# Change the edge color of the bars to a gradient that transitions from #3c9cd9 to #72dba2 by order
colors = [(39, 156, 217), (114, 186, 186)]
