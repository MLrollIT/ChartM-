...
# Fill the area below the step line that contains the center point of the bounding box with a gradient that transitions from the starting color '#560791' to the ending color '#b4de22'
x = np.arange(4)
y = [50, 60, 70, 80]
plt.fill_between(x, y, color='#560791', alpha=0.5)
plt.fill_between(x, y, color='#b4de22', alpha=0.5)