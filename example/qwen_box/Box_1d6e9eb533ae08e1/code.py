...
# Set the animated state of the boxes containing the center point of the bounding box to True
for box in bp['boxes']:
    box.set_animated(True)

# Change the transform to the pixel coordinate system
for box in bp['boxes']:
    box.set_transform(ax.transPixel)
