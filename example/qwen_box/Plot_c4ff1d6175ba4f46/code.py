...
# Set the transform of the line that contains the center point of the bounding box to the Coordinate system of subfigure.
bbox = ax.bbox_to_transform(ax.bbox.get_points()[1])
bbox.set_transform(ax.transAxes)

# Stroke the line with a linewidth of 4.646232360197592 and a #957b84 foreground color.
bbox.set_linewidth(4.646232360197592)
bbox.set_color('#957b84')
