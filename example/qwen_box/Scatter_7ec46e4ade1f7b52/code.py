...
# Change the transparency of the scatter points that share the same legend as those containing the center point of the bounding box to 0.48, and update their shape to 'diamond'
bbox = ax.bbox_to_anchor((0.5, 0.5), pad=10)
bbox_points = bbox.get_points()
bbox_points[0] = (bbox_points[0][0], bbox_points[0][1] * 0.48)
bbox_points[1] = (bbox_points[1][0], bbox_points[1][1] * 0.48)
bbox.set_points(bbox_points)
bbox.set_transform(ax.transAxes)

# Update the shape of the scatter points
bbox_points = bbox.get_points()
bbox_points[0] = (bbox_points[0][0], bbox_points[0][1] * 0.48)
bbox_points[1] = (bbox_points[1][0], bbox_points[1][1] * 0.48)
bbox.set_points(bbox_points)
