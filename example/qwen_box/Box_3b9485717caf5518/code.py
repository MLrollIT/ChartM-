...
# Modify the linewidth of the box body and median of the box that contain the center point of the bounding box to 0.69, and also disable the picker state for those box by setting it to False.
for box in bp['boxes']:
    box.set(linewidth=0.69, picker=False)
